function [result] = testing_ground_4(game_mode,same_msg,name_group_1,name_tra_1,name_rec_1,name_group_2,name_tra_2,name_rec_2)
...
if strcmp(game_mode,'test')
    for i = 0:loop_max_out-1
        ...
        subplot(2,2,4), plot(f,sub_4), title('Spectrum of Transmitters'), axis([0 Fs/4-dF 0 0.25])
        ...
        for j = 1:loop_max_in
            if mod(j,2) 
                ...
                if e_tra_2-(signal_tra_2^(2)) > 0
                    c_tra(i*loop_max_in+j+1) = c_tra(i*loop_max_in+j+1) + signal_tra_1;
