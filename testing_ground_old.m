...
game_mode = 'test'; % type of challenge (test, fight, co_op)
...
my_msg_1 = b_1; % gives the first control of how to send their message
my_msg_2 = b_2; % gives the second control of how to send their message
