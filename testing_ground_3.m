function [result] = testing_ground_3(game_mode,same_msg,name_group_1,name_tra_1,name_rec_1,name_group_2,name_tra_2,name_rec_2)
% Parameters 
%   game_mode : Must be a string either 'test', 'fight', or 'co_op' 
%   same_msg : 1 ==> group1 and group2 have the same message 0 ==>
%                    different messages
%   name_group_1 : A string containing the name of group 1 
%   name_tra_1 : function handle for group 1 transmitter 
%   name_rec_1 : function handle for group 1 receiver
%   name_group_2 : A string containing the name of group 2 
%   name_tra_2 : function handle for group 2 transmitter 
%   name_rec_2 : function handle for group 2 receiver
